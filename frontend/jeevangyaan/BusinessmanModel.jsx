...
Command: npx gltfjsx@6.5.3 public/buisness_man_with_talking_animation.glb -o BusinessmanModel.jsx 
...
export function Model(props) {
  ...
  const { scene, animations } = useGLTF('/buisness_man_with_talking_animation.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[1.571, 0, 0]} scale={0.93}>
...
useGLTF.preload('/buisness_man_with_talking_animation.glb')
